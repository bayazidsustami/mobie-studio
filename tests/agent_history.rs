...
fn test_history_tracking() {
    ...
    let action1 = Action::Tap { x: 100, y: 200, reasoning: "test 1".to_string() };
    let action2 = Action::Input { text: "hello".to_string(), reasoning: "test 2".to_string() };
    ...
    // Note: Comparison might need Action to implement PartialEq or we check reasoning
...
fn test_loop_detection() {
    ...
    let action = Action::Tap { x: 100, y: 200, reasoning: "stuck".to_string() };
...
fn test_history_limit() {
    ...
    history.push(Action::Tap { x: 1, y: 1, reasoning: "1".to_string() });
    history.push(Action::Tap { x: 2, y: 2, reasoning: "2".to_string() });
    history.push(Action::Tap { x: 3, y: 3, reasoning: "3".to_string() });
